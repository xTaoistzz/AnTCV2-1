...
// import { ChevronLeft, ChevronRight, Trash2, ChevronUp, ChevronDown } from 'lucide-react';
...
//       animate={{ opacity: 1 }}
//       exit={{ opacity: 0 }}
//       className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-5"
//     >
//       {!activeUrl && (
//         <motion.div
