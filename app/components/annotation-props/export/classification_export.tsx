...
const ExportDataset = () => {
    ...
    const [format, setFormat] = useState('Classification');
    ...
    return (
        <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 flex flex-col items-center justify-center py-72"
        >
            <motion.div
            ...
            >
                <h1 className="text-2xl font-bold mb-6 text-blue-800">Export Classification Dataset</h1>
                <div className="mb-6">
                    <label className="flex items-center space-x-3 cursor-pointer">
                        ...
                        />
                        <span className="text-blue-800">Classification Structure</span>
                    </label>
                </div>
                <motion.button
